const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-BikGRg3B.js","assets/index-CgYOV5jf.js","assets/index-CTSVA4Cu.css"])))=>i.map(i=>d[i]);
var __typeError = (msg) => {
  throw TypeError(msg);
};
...
Service({
  ...
  "createPost": Func([Text, Text], [PostId], []),
  "followUser": Func([UserId], [Bool], []),
  "getComments": Func([PostId], [Vec(CommentPublic)], ["query"]),
  "getFeed": Func([Nat, Nat], [FeedPage], ["query"]),
  ...
  "savePost": Func([PostId], [Bool], []),
  "unfollowUser": Func([UserId], [Bool], []),
  "unlikePost": Func([PostId], [Bool], []),
  "unsavePost": Func([PostId], [Bool], []),
  "updateProfile": Func([Text, Text, Text], [Bool], [])
});
const idlFactory = ({ IDL: IDL2 }) => {
  const PostId2 = IDL2.Text;
  const CommentId2 = IDL2.Text;
  const UserId2 = IDL2.Principal;
  const Timestamp2 = IDL2.Int;
  const CommentPublic2 = IDL2.Record({
  ...
  const FeedPage2 = IDL2.Record({
    "nextOffset": IDL2.Opt(IDL2.Nat),
    "posts": IDL2.Vec(PostPublic2)
  });
  ...
  const Notification2 = IDL2.Record({
    ...
    "notifId": NotifId2,
    "actorId": UserId2,
    "postId": IDL2.Opt(PostId2)
  });
  return IDL2.Service({
    "addComment": IDL2.Func([PostId2, IDL2.Text], [CommentId2], []),
    "createPost": IDL2.Func([IDL2.Text, IDL2.Text], [PostId2], []),
    "followUser": IDL2.Func([UserId2], [IDL2.Bool], []),
    "getComments": IDL2.Func([PostId2], [IDL2.Vec(CommentPublic2)], ["query"]),
    "getFeed": IDL2.Func([IDL2.Nat, IDL2.Nat], [FeedPage2], ["query"]),
    ...
    "savePost": IDL2.Func([PostId2], [IDL2.Bool], []),
    "unfollowUser": IDL2.Func([UserId2], [IDL2.Bool], []),
    "unlikePost": IDL2.Func([PostId2], [IDL2.Bool], []),
    "unsavePost": IDL2.Func([PostId2], [IDL2.Bool], []),
    "updateProfile": IDL2.Func([IDL2.Text, IDL2.Text, IDL2.Text], [IDL2.Bool], [])
  });
};
...
function from_candid_FeedPage_n1(_uploadFile, _downloadFile, value) {
  return from_candid_record_n2(_uploadFile, _downloadFile, value);
}
function from_candid_Notification_n6(_uploadFile, _downloadFile, value) {
...
function useGetFeed(offset = 0n, limit = 10n) {
  ...
  return useQuery({
    ...
    queryFn: async () => {
      ...
      const { Principal: Principal2 } = await __vitePreload(async () => {
        const { Principal: Principal3 } = await import("./index-BikGRg3B.js").then((n) => n.i);
        return { Principal: Principal3 };
      }, true ? __vite__mapDeps([0,1,2]) : void 0);
      return actor.getUser(Principal2.fromText(uid));
    },
...
function useFollowUser() {
  ...
  return useMutation({
    mutationFn: async (uid) => {
      ...
      return actor.followUser(Principal2.fromText(uid));
    },
    onSuccess: (_, uid) => {
...
function useUnfollowUser() {
  ...
  return useMutation({
    mutationFn: async (uid) => {
      ...
      return actor.unfollowUser(Principal2.fromText(uid));
    },
    onSuccess: (_, uid) => {
      qc.invalidateQueries({ queryKey: ["user", uid] });
      qc.invalidateQueries({ queryKey: ["myProfile"] });
...
export {
  ...
  useSavePost as h,
  useGetFeed as i,
  useGetMyProfile as j,
  useFollowUser as k,
  useUnfollowUser as l,
  useUpdateProfile as m,
  useRegisterUser as u
};
