...
import { Bell, Heart, MessageCircle, Moon, Package, Plus, Send, Sun, Zap } from "lucide-react";
...
const POSTS = [
  ...
  { id: "2", username: "tech_by_kai", seed: "kai", imgSeed: "post2", imgBg: "c0aede", caption: "Setup tour 🖥️ Everything linked in marketplace! #techsetup #productivity", likes: 5102, comments: 287, time: "4j" },
  { id: "3", username: "glowlab.id", seed: "glow", imgSeed: "post3", imgBg: "d1f4cc", caption: "Glass skin routine 🧴 30 days challenge results! #skincare #glowup", likes: 4410, comments: 320, time: "6j" },
  { id: "4", username: "mia.creates", seed: "mia", imgSeed: "post4", imgBg: "ffd5dc", caption: "Handmade with love 🎨 Each piece is unique! #handmade #ceramic", likes: 1920, comments: 98, time: "8j" },
];
  ...
  return (
    <motion.div initial={{ opacity: 0, y: 12 }} animate={{ opacity: 1, y: 0 }} className="bg-card border border-border rounded-2xl overflow-hidden">
      <div className="flex items-center gap-3 px-4 py-3">
        ...
        <button type="button" className="text-xs text-primary font-semibold border border-primary/30 px-3 py-1 rounded-full hover:bg-primary/10 transition-smooth">
          Ikuti
        </button>
      </div>
      ...
      <div className="px-4 py-3 space-y-2">
        <div className="flex items-center gap-4">
          ...
          <button type="button" className="ml-auto">
            <Send size={20} className="stroke-foreground fill-transparent" />
          </button>
        </div>
